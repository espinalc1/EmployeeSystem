...
@Service
public class EmployeeDataEncryption {
	public String[] saltHashing(String password) { // place email instead of password
		// to be returned
		...
		try {
			...
			// convert each character in byte array into a String using StringBuilder append
			// function.
